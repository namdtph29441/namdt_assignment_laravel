                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <input type="number" name="quantity" id="quantity" class="form-control" value="@isset($request['quantity']){{ $request['quantity'] }}@endisset">
                                <span id="mes_sdt"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <textarea id="mytextarea"  id="detail"  name="detail" placeholder="Mô tả sản phẩm"value="@isset($request['detail']){{ $request['detail'] }}@endisset"></textarea>
                                <span id="mes_sdt"></span>
                            </div>
                        </div>
                        <div class="form-group">
