                    ...
                    <div class="col-xs-12" style="text-align:center;">
                        <div class="form-group">
                            ...
                            <a href="{{ url('/user') }}" class="btn btn-default btn-sm "><i class="fa fa-remove"></i>
                                Clear </a>
                            <a href="/role/add" class="btn btn-info btn-sm"><i class="fa fa-user-plus" style="color:white;"></i>
                                Add new</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="double-scroll">
                    <table style="width: auto" class="table table-bordered">
                        <tr>
                            ...
                            <th class="text-center">Chức Năng
                        </tr>
@foreach($list as $l)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('route_BackEnd_role_detail',['id'=>$l->id])}}" class="btn btn-warning ">Sửa</a>
                                <a href="{{route('route_BackEnd_role_delete',['id'=>$l->id])}}" onclick="return confirm('Bạn có muốn xoá ?')" class="btn btn-danger ">Xoá</a>
                            </td>
                        </tr>
                        @endforeach
                    </table>
