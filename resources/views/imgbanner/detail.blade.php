...
@section('content')
    ...
    <!-- Phần nội dung riêng của action  -->
        <form class="form-horizontal " action="{{route('route_BackEnd_imgbanner_update',['id'=>request()->route('id')])}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <div class="row">
                                    <div class="col-xs-6">
                                        <img id="mat_truoc_preview" src="{{ $objItem->url?''.Storage::url($objItem->url):'http://placehold.it/100x100' }}" alt="your image"
            ...
            <div class="text-center">
                ...
                <a href="{{route('route_BackEnd_imgbanner_list')}}" class="btn btn-default">Cancel</a>
            </div>
            <!-- /.box-footer -->
        </form>
