                ...
                <div class="double-scroll">
                    <table style="width: auto" class="table table-bordered">
                        <tr>
                            ...
                            <th class="text-center">Chi tiết hoá đơn</th>
...
@foreach($list as $l)
                        <tr>
                            ...
                            <td class="text-center">{{$l->status == 1?"Đã giao hàng":"chưa giao hàng"}}</td>
                            <td class="text-center">{{$l->order_date}}</td>
                            <td class="text-center">{{$l->delivery_date_}}</td>
                            <td class="text-center">{{$l->total_money}}</td>
                            <td class="text-center">{{$l->user_name}}</td>
                            <td>
