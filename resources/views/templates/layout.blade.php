...
<head>
    ...
    <title>NamMobile::@yield('title')</title>
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                <li class=" active menu-open ">
                    <a href="{{route('route_BackEnd_home')}}"><i class="fa fa-home"></i> <span>Trang chủ</span></a>
                ...
                <li class=" active menu-open ">
                    <a href="{{route('route_BackEnd_user_list')}}"><i class="fa fa-users"></i> <span>Quản lí tài khoản</span></a>
                </li>
                <li class=" active menu-open ">
                    <a href="{{route('route_BackEnd_role_list')}}"><i class="fa fa-user-secret"></i> <span>Quản lí chức vụ</span></a>
                </li>
                <li class=" active menu-open ">
                    <a href="{{route('route_BackEnd_category_list')}}"><i class="fa fa-list-alt"></i> <span>Quản lí danh mục</span></a>
                </li>
                <li class=" active menu-open ">
                    <a href="{{route('route_BackEnd_product_list')}}"><i class="fa fa-product-hunt"></i> <span>Quản lí sản phẩm</span></a>
                </li>
                <li class=" active menu-open ">
                    <a href="{{route('route_BackEnd_promotion_list')}}"><i class="fa fa-bolt"></i> <span>Quản lí khuyến mãi</span></a>
                </li>
                <li class=" active menu-open ">
                    <a href="{{route('route_BackEnd_imgbanner_list')}}"><i class="fa fa-image"></i> <span>Quản lí ảnh banner</span></a>
                </li>
                <li class=" active menu-open ">
                    <a href="{{route('route_BackEnd_invoice_list')}}"><i class="fa fa-book"></i> <span>Quản lí hoá đơn</span></a>
                </li>
            </ul>
        </section>
        <!-- /.sidebar -->
