    ...
    <!-- Phần nội dung riêng của action  -->
        <form class="form-horizontal " action="{{route('route_BackEnd_user_update',['id'=>request()->route('id')])}}" method="post" enctype="multipart/form-data">
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="address" class="col-md-3 col-sm-4 control-label">Address <span class="text-danger">(*)</span></label>
                            <div class="col-md-9 col-sm-8">
                        ...
                        <div class="form-group">
                            <label for="role" class="col-md-3 col-sm-4 control-label">Chức vụ <span class="text-danger">(*)</span></label>
                            <div class="col-md-9 col-sm-8">
                                <select name="role_id" class="form-control" >
                                    @foreach($roles as $r )
                                    <option <?php if ($objItem->role_id == $r->id) echo "selected" ?> value="<?= $r->id ?>"><?= $r->name?></option>
                                    @endforeach
                                </select>
                                <span id="mes_sdt"></span>
                            </div>
                        ...
                        <div class="form-group">
                            <label for="email" hidden class="col-md-3 col-sm-4 control-label">Mật khẩu <span class="text-danger">(*)</span></label>
                            <div class="col-md-9 col-sm-8">
                                <input type="hidden" name="password" id="password" class="form-control" value="@isset($request['password']){{ $request['password'] }}@endisset">
                                <span id="mes_sdt"></span>
                            </div>
                        </div>
            ...
            <div class="text-center">
                ...
                <a href="{{route('route_BackEnd_user_list')}}" class="btn btn-default">Cancel</a>
            </div>
            <!-- /.box-footer -->
        </form>
