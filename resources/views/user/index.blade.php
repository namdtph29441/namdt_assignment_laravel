            ...
            <form action="" method="get">
                <div class="row">
                    ...
                    <div class="col-xs-12" style="text-align:center;">
                        <div class="form-group">
                            <button type="button" name="btnSearch" class="btn btn-primary btn-sm "><i
                                    class="fa fa-search" style="color:white;"></i> Search
                            </button>
                            <a href="{{ url('/user') }}" class="btn btn-default btn-sm "><i class="fa fa-remove"></i>
                                Clear </a>
                            <a href="/user/add" class="btn btn-info btn-sm"><i class="fa fa-user-plus" style="color:white;"></i> Add new</a>
                        </div>
                    </div>
                </div>
...
@foreach($list as $l)
                        <tr>
                            ...
                            <td class="text-center"><a style="color:#333333;font-weight: bold;"  style="white-space:unset;text-align: justify;"> {{$l->name}} </a></td>
                            ...
                            <td class="text-center">{{$l->role_name}}</td>
                            <td class="text-center">
                                <a href="{{route('route_BackEnd_user_detail',['id'=>$l->id])}}" class="btn btn-warning ">Sửa</a>
                                <a href="{{route('route_BackEnd_user_delete',['id'=>$l->id])}}" onclick="return confirm('Bạn có muốn xoá ?')" class="btn btn-danger ">Xoá</a>
                            </td>
                        </tr>
                        @endforeach
                    </table>
